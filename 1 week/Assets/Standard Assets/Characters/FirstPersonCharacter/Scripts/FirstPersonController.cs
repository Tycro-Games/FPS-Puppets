...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void GetInput (out float speed)
        {
...
#if !MOBILE_INPUT
            // On standalone builds, walk/run speed is modified by a key press. keep track of
            // whether or not the character is walking or running
            ...
            // handle speed change to give an fov kick only if the player is going to a run, is
            // running and the fovkick is to be used
